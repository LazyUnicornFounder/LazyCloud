...
Add a complete autonomous dropshipping engine called Lazy Drop to this project. It connects your Lovable site to AutoDS — giving you access to 800M+ products from 25+ global suppliers, automatic price and stock monitoring, one-click product import, and fully automated order fulfilment.`;
...
function CopyPromptButton({ text }: { text: string }) {
  ...
  return (
    <button onClick={handleCopy} className="inline-flex items-center gap-2 font-body text-[13px] tracking-[0.15em] uppercase px-8 py-3 font-semibold hover:opacity-80 transition-opacity" style={{ backgroundColor: "#c8a961", color: "#0a0a08" }}>
...
export default function LazyDropPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="Lazy Drop — Autonomous Dropshipping Engine for Lovable"
