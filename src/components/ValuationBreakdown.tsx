...
const ValuationBreakdown = () => (
  <>
    ...
    <p className="font-body text-[13px] text-primary font-semibold leading-relaxed mb-4">
    ...
    <div className="space-y-1.5">
      {metrics.map((m, i) => (
        ...
        >
          <div>
            <p className="font-display text-[14px] font-bold tracking-wide uppercase text-foreground/70">
              {m.label}
            </p>
            <p className="font-body text-[13px] text-foreground/65">{m.note}</p>
          </div>
    ...
    <div className="mt-4 p-2.5 rounded-xl border border-primary/20 bg-primary/5">
      <p className="font-display text-[13px] tracking-[0.15em] uppercase text-primary/60 mb-0.5">
        Current Stage
      </p>
      <p className="font-display text-xl font-extrabold text-primary">
        Pre-revenue
      </p>
      <p className="font-body text-[14px] text-foreground/65 mt-0.5">
