  ...
  return (
    ...
    >
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className={`w-full text-left relative group rounded-2xl border ${step.borderColor} bg-card/60 backdrop-blur-xl p-6 md:p-8 transition-all duration-300 hover:shadow-[0_0_40px_rgba(255,255,255,0.05)] cursor-pointer`}
      >
        {/* glow */}
        <div
  ...
  return (
    <div className="min-h-screen text-foreground relative">
      ...
      <div className="relative z-10 px-4 md:px-6 pb-20">
        ...
        >
          <div className="rounded-2xl border border-primary/20 bg-card/60 backdrop-blur-xl p-8 md:p-10">
