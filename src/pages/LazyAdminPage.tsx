      ...
      <main className="min-h-screen bg-background text-foreground">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <motion.div {...fade}>
              <div className="flex items-center justify-center gap-3 mb-6">
                <span className="font-body text-[14px] tracking-[0.2em] uppercase text-[#c8a961]/60">Works with all Lazy engines</span>
        ...
        <section className="py-20 px-6 border-t border-border">
          <div className="max-w-2xl mx-auto">
            <motion.div {...fade}>
              <h2 className="font-display text-2xl md:text-3xl font-bold tracking-tight mb-6">Twenty-two engines. Twenty-two dashboards. Nobody has time for that.</h2>
              <p className="font-body text-foreground/50 leading-relaxed">
                Every Lazy engine ships with its own setup page. That is intentional — each engine installs independently into your project. But checking twenty-two separate dashboards every morning is not autonomous. It is the opposite of lazy. Lazy Admin solves that by pulling everything into one place. One URL. One sidebar. One morning check.
              </p>
            </motion.div>
          </div>
        </section>
