        ...
        <div className="flex flex-col md:flex-row md:items-end md:gap-6 w-full">
          ...
          <motion.div
            ...
            <motion.div
              ...
              <div className="bg-white/10 backdrop-blur-3xl border border-primary/20 border-b-0 rounded-t-2xl px-6 py-2.5 inline-block shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
