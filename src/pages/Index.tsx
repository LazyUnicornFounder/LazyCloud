    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/60 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); history.replaceState(null, '', window.location.pathname); }} className="font-display text-lg font-bold tracking-tight cursor-pointer hover:text-primary transition-colors duration-300">Lazy Cloud</a>
      ...
      <section className="relative min-h-screen flex flex-col px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-left relative z-10 flex-1 flex flex-col justify-center pt-20 px-6">
          <motion.div
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-foreground/90 max-w-xl mb-10 leading-relaxed font-medium drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]"
          >
            Lazy Cloud indexes your entire file archive with AI and lets your team search in plain language.
          </motion.p>
