...
Add an autonomous meeting-to-content agents? called Lazy Granola to this project...`;
        ...
        <section className="py-20 px-6 border-t border-border">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-body text-foreground/50 text-[14px] leading-relaxed max-w-3xl mx-auto">
              Lazy Granola does not replace any other Lazy agents?. It feeds them. If you have Lazy Blogger installed meeting posts appear on your blog automatically. If you have Lazy Linear installed action items appear in your board automatically. Install what you have. Lazy Granola connects to whatever is there.
            </p>
          </div>
        </section>
