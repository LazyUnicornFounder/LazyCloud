    ...
    <section id="blog" className="relative z-10 px-8 md:px-12 pb-16 scroll-mt-24">
      <div className="max-w-5xl">
        ...
        <motion.div
          ...
          className="bg-white/10 backdrop-blur-3xl rounded-3xl px-8 py-10 border border-primary/20 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(var(--primary-rgb),0.08)] mb-8"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {allPosts.map((post, i) => (
            ...
            >
              <Link
                to={`/blog/${post.slug}`}
                className="group flex flex-col h-full bg-white/10 backdrop-blur-3xl rounded-3xl border border-primary/20 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(var(--primary-rgb),0.08)] overflow-hidden hover:border-primary/40 hover:shadow-[0_8px_32px_rgba(0,0,0,0.5),0_0_30px_rgba(var(--primary-rgb),0.15)] transition-all duration-300"
              >
                {/* Thumbnail */}
