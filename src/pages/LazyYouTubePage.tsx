  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        ...
        url="/lazy-youtube"
        keywords="YouTube content agents?, autonomous YouTube, video to blog post, YouTube SEO, YouTube transcript, Lovable YouTube"
      />
      <Navbar />
        ...
        <section className="max-w-3xl mx-auto px-6 mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-0 border border-border">
            {[
              ...
              { badge: "Month 6", desc: "Your site has 60+ indexed articles from your videos. You rank for dozens of keywords your videos never touched. AI agents? cite you regularly." },
            ].map((item, i) => (
              <motion.div
                key={item.badge}
                initial="hidden"
