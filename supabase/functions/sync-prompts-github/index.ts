...
function buildReadme(prompts: PromptPayload[]) {
  const lines: string[] = [
    ...
    "4. Your engine is live!",
    "",
    "> **Note:** Most engines work out of the box. Some (e.g. Lazy Voice, Lazy Stream, Lazy Pay) require external API keys or service credentials — the prompt will guide you through setup when needed.",
    "",
    "## 📦 Engines",
    "",
