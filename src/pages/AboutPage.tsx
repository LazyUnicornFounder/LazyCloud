          ...
          >
            ...
            <div className="mt-12 pt-8 border-t border-border">
              ...
              <div className="flex items-center gap-4 mt-3">
                ...
                <a href="https://www.linkedin.com/in/saadsahawneh" target="_blank" rel="noopener noreferrer" className="font-body text-xs text-foreground/30 hover:text-foreground transition-colors">LinkedIn</a>
              </div>
            </div>
