      ...
      <main className="relative z-10 pt-28 pb-32 px-6 md:px-12">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="rounded-2xl overflow-hidden border border-foreground/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] mb-8"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-background/60 backdrop-blur-2xl rounded-3xl px-8 py-8 border border-foreground/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)]"
          >
