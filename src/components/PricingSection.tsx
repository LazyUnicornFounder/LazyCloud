      ...
      <div className="max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-3xl rounded-2xl border border-primary/20 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(var(--primary-rgb),0.08)] flex flex-col"
          >
            ...
            <p className="font-body text-xs text-muted-foreground mt-1 mb-6">
              Forever free
            </p>
            ...
            <button
              ...
              className="mt-6 w-full font-body text-[11px] tracking-[0.15em] uppercase border border-foreground/20 text-foreground/70 hover:text-primary hover:border-primary/40 px-6 py-2.5 rounded-full font-semibold transition-colors"
            >
              Submit for free
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-3xl rounded-2xl border border-primary/30 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden flex flex-col"
          >
            {/* Glow */}
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="inline-flex items-center gap-1 bg-primary/10 text-primary border border-primary/20 rounded-full px-2 py-0.5 font-body text-[9px] tracking-wider uppercase font-semibold">
                <Sparkles size={9} />
                Popular
              </span>
            </div>
            ...
            <button
              onClick={onSubmitClick}
              className="mt-6 w-full font-body text-[11px] tracking-[0.15em] uppercase bg-primary text-primary-foreground px-6 py-2.5 rounded-full font-semibold hover:opacity-90 transition-opacity"
            >
              Get listed →
            </button>
          </motion.div>
