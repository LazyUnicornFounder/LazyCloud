...
const faqs = [
  { q: "Do I need all the Lazy agents installed first?", a: "No. Lazy Admin works with any combination. Install one engine and Lazy Admin shows one panel. Install all twenty-five and it shows everything. It detects what is there." },
  { q: "Does it replace the individual setup pages?", a: "No. Each agent still has its own /lazy-[engine]-setup page for configuration. Lazy Admin is for monitoring and control, not initial setup." },
  { q: "Can I trigger engine runs from the dashboard?", a: "Yes. Every agent panel has a Run Now button that calls that engine's primary function immediately without leaving the dashboard." },
  ...
  { q: "What if I install a new engine after setting up Lazy Admin?", a: "Lazy Admin detects installed agents dynamically. Install a new engine and its panel appears in the sidebar automatically on the next page load. No prompt needed." },
      ...
      <main className="min-h-screen bg-background text-foreground">
          ...
          <div className="max-w-2xl mx-auto">
            <motion.div {...fade}>
              ...
              <p className="font-body text-foreground/50 leading-relaxed">
                Every Lazy engine ships with its own setup page. That is intentional — each agent installs independently into your project. But checking twenty-five separate dashboards every morning is not autonomous. It is the opposite of lazy. Lazy Admin solves that by pulling everything into one place. One URL. One sidebar. One morning check.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto">
            <motion.div {...fade}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {["Install any Lazy agents into your Lovable project.", "Copy the Lazy Admin setup prompt from this page.", "Paste it into your existing Lovable project.", "Lazy Admin detects which engines are installed and builds the right dashboard automatically."].map((step, i) => (
            ...
            <motion.div {...fade}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  { time: "10–30 seconds", text: "Scan the agent status grid. Check post counts, revenue, citation rate, security score. See if any engine has an error badge." },
        ...
        <section className="py-24 px-6 border-t border-border">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="font-body text-foreground/60 text-sm mt-4 max-w-md mx-auto">Open your Lovable project, paste it into the chat. The dashboard builds itself around whatever engines you have installed.</p>
          </div>
        </section>
      </main>
    </>
