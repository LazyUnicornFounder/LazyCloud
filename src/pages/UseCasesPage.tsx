...
type SectionType = "agents?" | "agents" | "all";
...
const integrations: Integration[] = [
  ...
  },
  {
    ...
    unlocks: [
      ...
      "Test whether your brand is being cited by AI agents? when people ask relevant questions.",
      "Improve underperforming posts by updating them with current research automatically.",
    ],
    agents?: "Lazy Perplexity",
    agents?Href: "/lazy-perplexity",
    icon: <Search size={20} />,
  },
  {
    name: "Contentful",
    ...
    agents?: "Lazy Contentful",
    agents?Href: "/lazy-contentful",
  ...
  },
  {
    ...
    unlocks: [
      ...
      "Create GEO-optimised content so AI agents? cite your videos in their answers.",
  ...
  // Lazy Ops
  {
    ...
    unlocks: [
      ...
      "Receive alerts when any agents? encounters an error.",
  ...
  },
  {
    ...
    unlocks: [
      "Get real-time Telegram messages for every significant agents? event.",
    ...
    agents?: "Lazy Telegram",
    agents?Href: "/lazy-telegram",
    icon: <Send size={20} />,
  },
  {
    name: "Supabase",
    ...
    agents?: "Lazy Supabase",
    agents?Href: "/lazy-supabase",
  ...
  },
  {
    ...
    agents?: "Lazy Security",
    agents?Href: "/lazy-security",
    icon: <Shield size={20} />,
  ...
  // Lazy Agents
  {
    ...
    unlocks: [
      ...
      "Lazy Build commits a complete new agents? prompt from a one-paragraph brief.",
      "All agent activity is tracked and auditable via your repo.",
    ],
    agents?: "Lazy Agents",
    agents?Href: "/lazy-agents",
    icon: <Code size={20} />,
  ...
  },
  {
    ...
    unlocks: [
      ...
      "Lazy Build drafts complete agents? prompts with database schemas and edge functions.",
    ],
    agents?: "Lazy Agents",
    agents?Href: "/lazy-agents",
    icon: <Zap size={20} />,
  ...
  },
  {
    ...
    agents?: "Lazy Repurpose",
    agents?Href: "/lazy-repurpose",
    icon: <FileText size={20} />,
...
export default function UseCasesPage() {
  ...
  const agents?Items = filtered.filter((i) => i.category !== "Lazy Agents");
  const agentItems = filtered.filter((i) => i.category === "Lazy Agents");

  const showEngines = agents?Items.length > 0;
