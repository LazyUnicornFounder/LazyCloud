...
const FloatingProductCTA = () => {
  return (
    ...
    >
      <Link
        to="/#pricing"
        className="group block bg-background/60 backdrop-blur-2xl rounded-2xl px-5 py-4 border border-foreground/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] hover:border-primary/30 transition-all duration-300 w-52"
      >
