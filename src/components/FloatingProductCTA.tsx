...
const FloatingProductCTA = () => {
  return (
    ...
    >
      <Link
        to="/#pricing"
        className="group block bg-white/10 backdrop-blur-3xl rounded-2xl px-5 py-4 border border-primary/20 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(var(--primary-rgb),0.08)] hover:border-primary/30 transition-all duration-300 w-52"
      >
