...
const categories: Category[] = [
    ...
    products: [
      {
        ...
        free: ["Setup prompt included", "All 25 agents? in one prompt", "Unified admin dashboard", "Master orchestrator", "Weekly AI performance report"],
        pro: { price: "$99", features: ["Hosted version — zero config", "Auto-scaling agents? execution", "Priority AI model access", "Dedicated support", "Custom agents? configuration"], comingSoon: true },
      },
    ],
  },
  {
    ...
    label: "Content",
    products: [
      { name: "Lazy Blogger", tagline: "Autonomous blog agents?", link: "/lazy-blogger", free: ["Setup prompt included", "Unlimited AI-generated posts", "Custom tone, topics & frequency", "Auto-publish on schedule"], pro: { price: "$19", features: ["Hosted version — no setup needed", "Multi-site publishing", "Social media cross-posting", "Advanced analytics dashboard"], comingSoon: true } },
      { name: "Lazy SEO", tagline: "Autonomous SEO agents?", link: "/lazy-seo", free: ["Setup prompt included", "Keyword discovery & tracking", "SEO-optimised article generation", "Auto-publish to your blog"], pro: { price: "$19", features: ["Hosted version", "Backlink monitoring", "Competitor keyword tracking", "Weekly SEO reports"], comingSoon: true } },
      { name: "Lazy GEO", tagline: "Autonomous GEO agents?", link: "/lazy-geo", free: ["Setup prompt included", "AI citation tracking", "Citation-ready content generation", "Brand mention detection"], pro: { price: "$19", features: ["Hosted version", "Real-time citation alerts", "Competitor citation tracking", "Monthly GEO reports"], comingSoon: true } },
      ...
      { name: "Lazy Perplexity", tagline: "Autonomous research agents?", link: "/lazy-perplexity", free: ["Setup prompt included", "Real-time niche research", "Citation-rich content generation", "Brand visibility testing"], pro: { price: "$29", features: ["Hosted version", "Daily citation monitoring", "Competitive citation tracking", "Advanced scheduling"], comingSoon: true } },
  ...
  },
  {
    ...
    label: "Commerce",
    products: [
      { name: "Lazy Store", tagline: "Autonomous Shopify agents?", link: "/lazy-store", free: ["Setup prompt included", "Shopify integration", "Product discovery & listing", "Conversion optimisation"], pro: { price: "$29", features: ["Hosted version", "Multi-store management", "Advanced pricing algorithms", "Revenue analytics"], comingSoon: true } },
      ...
      { name: "Lazy Pay", tagline: "Autonomous payments agents?", link: "/lazy-pay", free: ["Setup prompt included", "Polar integration", "Checkout & subscriptions", "Payment webhooks"], pro: { price: "$19", features: ["Hosted version", "Multi-gateway support", "Revenue dashboards", "Automated dunning"], comingSoon: true } },
      { name: "Lazy SMS", tagline: "Autonomous SMS agents?", link: "/lazy-sms", free: ["Setup prompt included", "Twilio integration", "Automated SMS campaigns", "Conversion tracking"], pro: { price: "$19", features: ["Hosted version", "Advanced segmentation", "A/B testing", "Compliance automation"], comingSoon: true } },
      { name: "Lazy Mail", tagline: "Autonomous email agents?", link: "/lazy-mail", free: ["Setup prompt included", "Subscriber capture", "AI-written welcome sequences", "Self-improving subject lines"], pro: { price: "$19", features: ["Hosted version — zero config", "Multi-list segmentation", "A/B testing", "Advanced analytics"], comingSoon: true } },
    ],
  },
  {
    key: "media",
    label: "Media",
    products: [
      { name: "Lazy Voice", tagline: "Autonomous audio agents?", link: "/lazy-voice", free: ["Setup prompt included", "Blog-to-podcast conversion", "AI voice narration", "RSS feed generation"], pro: { price: "$19", features: ["Hosted version", "Custom voice cloning", "Multi-language narration", "Listener analytics"], comingSoon: true } },
      { name: "Lazy Stream", tagline: "Autonomous Twitch agents?", link: "/lazy-stream", free: ["Setup prompt included", "VOD transcription", "Stream recap generation", "SEO article writing"], pro: { price: "$19", features: ["Hosted version", "Automatic clip editing", "YouTube cross-posting", "Advanced analytics"], comingSoon: true } },
      { name: "Lazy YouTube", tagline: "Autonomous YouTube agents?", link: "/lazy-youtube", free: ["Setup prompt included", "Video-to-transcript publishing", "SEO + GEO article generation", "Auto chapter markers"], pro: { price: "$19", features: ["Hosted version", "Comment intelligence extraction", "Multi-channel support", "Advanced analytics"], comingSoon: true } },
    ],
  },
  {
    key: "dev",
    label: "Dev",
    products: [
      { name: "Lazy GitHub", tagline: "Autonomous GitHub agents?", link: "/lazy-github", free: ["Setup prompt included", "Commit-to-changelog generation", "Release notes automation", "Developer blog publishing"], pro: { price: "$19", features: ["Hosted version", "Multi-repo support", "Advanced formatting", "API docs generation"], comingSoon: true } },
      { name: "Lazy GitLab", tagline: "Autonomous GitLab agents?", link: "/lazy-gitlab", free: ["Setup prompt included", "Changelog generation", "Release notes automation", "Developer blog publishing"], pro: { price: "$19", features: ["Hosted version", "Multi-repo support", "Advanced formatting", "Custom templates"], comingSoon: true } },
      { name: "Lazy Linear", tagline: "Autonomous Linear agents?", link: "/lazy-linear", free: ["Setup prompt included", "Changelog from cycles", "Public roadmap publishing", "Product blog posts"], pro: { price: "$19", features: ["Hosted version", "Multi-team support", "Advanced formatting", "Custom publishing rules"], comingSoon: true } },
      { name: "Lazy Design", tagline: "Autonomous design agents?", link: "/lazy-design", free: ["Setup prompt included", "Page auditing", "21st.dev component suggestions", "AI fallback prompts"], pro: { price: "$19", features: ["Hosted version — zero config", "Automated weekly upgrades", "Advanced brand matching", "Multi-project support"], comingSoon: true } },
      { name: "Lazy Auth", tagline: "Autonomous auth agents?", link: "/lazy-auth", free: ["Setup prompt included", "Google Sign-In", "Email/password & magic link", "Protected routes & roles"], pro: { price: "$19", features: ["Hosted version — zero config", "Multi-tenant support", "Advanced session analytics", "Custom OAuth providers"], comingSoon: true } },
      { name: "Lazy Granola", tagline: "Autonomous meeting agents?", link: "/lazy-granola", free: ["Setup prompt included", "Granola meeting sync", "Auto blog posts from meetings", "Customer intelligence extraction"], pro: { price: "$19", features: ["Hosted version — zero config", "Multi-workspace support", "Advanced classification", "Custom output templates"], comingSoon: true } },
    ],
  },
  {
    key: "ops",
    label: "Ops",
    products: [
      { name: "Lazy Admin", tagline: "Unified dashboard for every agent", link: "/lazy-admin", free: ["Setup prompt included", "Auto-detects installed agents", "Master status indicator", "Unified activity feed", "Per-agents? deep dives"], pro: { price: "$9", features: ["Hosted version", "Multi-project support", "Team access with roles", "Weekly email digest", "Mobile app"], comingSoon: true } },
      ...
      { name: "Lazy Security", tagline: "Autonomous security agents?", link: "/lazy-security", free: ["Setup prompt included", "Automated Aikido pentesting", "Vulnerability monitoring", "Audit-ready reports"], pro: { price: "$19", features: ["Hosted version", "Automated report delivery", "Multi-project dashboard", "Alert integrations"], comingSoon: true } },
    ],
  },
  {
    key: "agents",
    ...
    products: [
      ...
      { name: "Lazy Build", tagline: "Autonomous agents? writer", link: "/lazy-build", free: ["Setup prompt included", "One-paragraph brief to agents?", "Database schema generation", "Edge function scaffolding"], pro: { price: "$29", features: ["Hosted version", "Multi-agents? generation", "Custom templates", "Priority AI model access"], comingSoon: true } },
