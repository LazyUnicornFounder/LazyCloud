        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <div className="mt-16 pt-8 border-t border-foreground/10 space-y-4 text-sm text-foreground/50 leading-relaxed">
              ...
              <p>
                <a href="https://lazyunicorn.ai/lazy-blogger" className="text-primary underline hover:opacity-80">Lazy Blogger</a> publishes SEO-optimised blog posts continuously.{" "}
